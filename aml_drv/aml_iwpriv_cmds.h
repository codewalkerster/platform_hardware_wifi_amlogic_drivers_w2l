...
enum aml_iwpriv_subcmd
{
    ...
    AML_IWP_SET_CSI = 105,
    AML_IWP_GET_CSI_DEBUG_INFO = 106,
    ...
    AML_COEX_GET_STATUS = 116,
    AML_IWP_SET_MCC_RATIO = 117,
    AML_IWP_ENABLE_USB_CAL_SPEED = 118,
    AML_IWP_SET_RTS_BASED_TXOP = 119,
    AML_IWP_GET_BT_DIGITAL_GAIN_EFUSE_TIMES = 120,
    AML_IWP_SET_BT_DIGITAL_GAIN = 121,
    AML_IWP_GET_BT_DIGITAL_GAIN = 122,
    AML_IWP_GET_RSSI = 123,
    AML_IWP_SET_AGG_TX_CNT_THRES = 124,
#ifdef CONFIG_AML_NAN_SUPPORT
    AML_IWP_NAN_ENABLE = 125,
    AML_IWP_SEND_NAN_PUB_REQ = 126,
    AML_IWP_SEND_NAN_SUB_REQ = 127,
    AML_IWP_SEND_NAN_FUP_REQ = 128,
#endif
    AML_IWP_RESET_EDCA = 129,
    AML_IWP_SET_DEAYL_ACK_RSSI_THR = 130,
