...
static const char *const aml_nanid2str[MSG_I(NAN_MAX)] = {
    [MSG_I(NAN_ENABLE_REQ)]         = "NAN_ENABLE_REQ",
    [MSG_I(NAN_ENABLE_CFM)]         = "NAN_ENABLE_CFM",
    [MSG_I(NAN_PUBLISH_REQ)]        = "NAN_PUBLISH_REQ",
    [MSG_I(NAN_SUBSCRIBE_REQ)]      = "NAN_SUBSCRIBE_REQ",
    [MSG_I(NAN_FOLLOW_UP_REQ)]      = "NAN_FOLLOW_UP_REQ",
};
#endif

#endif /* CONFIG_AML_FULLMAC */

const char *const *aml_id2str[NB_ID2STR] = {
