...
// Bit 5           rg_pmu_ana_xosc_sleep_msk      U     RW        default = 'h0
// Bit 6           rg_pmu_aldo_en_msk             U     RW        default = 'h0
// Bit 7           rg_pmu_aon_xosc_iso_en_msk     U     RW        default = 'h0
...
// Bit 8   :0      ro_pwrup_ack                   U     RO        default = 'h0
typedef union RG_PMU_A19_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int ro_pwrup_ack : 9;
...
#define RG_PMU_A35                                (CHIP_PMU_REG_BASE + 0x8c)
// Bit 31  :0      rg_ao_ram_pd_shutdown_sw       U     RW        default = 'h0
typedef union RG_PMU_A35_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A36                                (CHIP_PMU_REG_BASE + 0x90)
// Bit 31  :0      rg_ao_ram_pd_disb_gate_sw      U     RW        default = 'h0
typedef union RG_PMU_A36_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A37                                (CHIP_PMU_REG_BASE + 0x94)
// Bit 31  :0      rg_ao_ram_pd_sel0_sw           U     RW        default = 'hffffffff
typedef union RG_PMU_A37_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A38                                (CHIP_PMU_REG_BASE + 0x98)
// Bit 31  :0      rg_ao_ram_pd_sel1_sw           U     RW        default = 'h0
typedef union RG_PMU_A38_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A39                                (CHIP_PMU_REG_BASE + 0x9c)
// Bit 31  :0      rg_ao_ram_pd_shutdown_hw       U     RW        default = 'hffffffff
typedef union RG_PMU_A39_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A40                                (CHIP_PMU_REG_BASE + 0xa0)
// Bit 31  :0      rg_ao_ram_pd_disb_gate_hw      U     RW        default = 'hffffffff
typedef union RG_PMU_A40_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A41                                (CHIP_PMU_REG_BASE + 0xa4)
// Bit 31  :0      rg_ao_ram_pd_sel0_hw           U     RW        default = 'hffffffff
typedef union RG_PMU_A41_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A42                                (CHIP_PMU_REG_BASE + 0xa8)
// Bit 31  :0      rg_ao_ram_pd_sel1_hw           U     RW        default = 'hffffffff
typedef union RG_PMU_A42_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A43                                (CHIP_PMU_REG_BASE + 0xac)
...
typedef union RG_PMU_A43_FIELD
{
  unsigned int data;
  struct
  {
